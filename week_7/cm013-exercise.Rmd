...
1. to convey what you want to show to the reader as easy and fast as possible
1. 
1. 
1. 
1.
...
- Very weak, 4 countries below germany have less hours of les than an hour ( not a big difference).

- Main takeaway: Summarize the main takeaway from this question/discussion here: no need to include gridlines. should have started with 0 hours the differences would be better shown.
...
- <<Your answer here (and make sure to explain why you chose this answer)>> do not know: The Y axis is zoomed out. The X-axis doesn't have ticks.
...
- <<Your answer here (and make sure to explain why you chose this answer)>>: very weak: The Y-axis is misleading.
...
p <- gapminder %>% plot_ly(x = ~gdpPercap, y=~lifeExp, color= ~continent,
